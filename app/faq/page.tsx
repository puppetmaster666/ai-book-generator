...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Single Generation ($5.99): 1 generation + cover. Author Plan ($29/month): 5 generations/month with rollover. All plans include full commercial rights and downloads.',
      },
    },
  ],
};
