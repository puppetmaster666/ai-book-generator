...
const faqs = [
  {
    ...
    questions: [
      {
        q: 'What is BookForge?',
        a: 'BookForge is an AI-powered book generation platform. You provide your book idea, characters, and plot points, and our AI writes a complete book for you with consistent characters, plot, and style.'
      },
      {
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#4A5568]">
              Everything you need to know about BookForge
            </p>
          </div>
